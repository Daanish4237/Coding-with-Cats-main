...
// Define toolbox with categories and custom blocks
const toolboxLevel3 = {
...
async function runCode() {
    ...
    try {
        ...
        // Check answer - Convert "42" to int and back to string
        ...
        if (actualOutput === expectedOutput) {
            ...
            if (result && result.success) {
                checkDiv.innerHTML = `
                    <div class="success-message">
                        ✅ Correct! Great job with type conversion!<br>
                        Score: 100 points<br>
                        Rank: #${result.rank}<br>
                        🎉 Level 3 Complete!
                    </div>
            ...
            checkDiv.innerHTML = `
                <div class="error-message">
                    ...
                    Got: "${actualOutput}"<br>
                    <small>💡 Hint: Use int() to convert "42" to a number, then use str() to convert it back to a string before printing.</small>
                </div>
            `;
        }
...
document.getElementById('leaderboardBtn').addEventListener('click', () => {
    window.location.href = '/CODING-WITH-CATS-MAIN/Quiz-project/leaderboard.html?world=1&level=3';
});